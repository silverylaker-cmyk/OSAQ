        ...
        if (reachable) {
          add(
            ...
            '구글까지는 닿았지만 스크립트가 설문 프로그램이 읽을 수 있는 답을 주지 않았습니다. ' +
              '거의 대부분 <b>배포 설정</b> 문제입니다. ① 액세스 권한이 <b>“모든 사용자”</b> 인지 확인하세요 — ' +
              '<b>“Google 계정이 있는 모든 사용자”</b>로 되어 있으면 구글에 로그인된 PC에서는 되고 <b>태블릿에서는 실패</b>합니다. ' +
              '② 배포 › 배포 관리 › ✏️ › 버전 <b>새 버전</b> › 배포 로 다시 배포하고, ③ <b>다음 사용자로 실행: 나</b> 인지 확인해 주세요. ' +
