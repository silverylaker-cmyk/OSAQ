        ...
        if (reachable) {
          add(
            ...
            '구글까지는 닿았지만 스크립트가 설문 프로그램이 읽을 수 있는 답을 주지 않았습니다. ' +
              '거의 대부분 <b>배포 설정</b> 문제입니다. ① Apps Script 편집기에서 <b>approveAndTest</b> 함수를 ▷실행해 권한 승인을 다시 받고, ' +
              '② 배포 › 배포 관리 › ✏️ › 버전 <b>새 버전</b> › 배포 로 다시 배포하되, ' +
              '③ <b>다음 사용자로 실행: 나</b> · <b>액세스 권한: 모든 사용자</b> 인지 확인해 주세요. ' +
